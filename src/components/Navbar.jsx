...
const Navbar = () => {
    ...
    return (
        <div className={NavStyle.navPcContainer}>
            <Link to='/'> <div className={NavStyle.navPcLogo}><img src={Logo} alt="Logo"/></div></Link>
            <ul className={NavStyle.pcUl}>
                <li className='p-4 text-[#fff]'><Link to='/'>Home</Link></li>
                <li className='p-4 text-[#fff]'><Link to='/pricingpage'>Pricing</Link></li>
                <li className='p-4 text-[#fff]'><Link to='/faqpage'>FAQ</Link></li>
                <li className='p-4 text-[#fff]'><Link to='/contactpage'>Contact</Link></li>
            </ul>
            ...
            <Link to='/'><div className={NavStyle.navMobiLogo}><img src={Logo} alt="Logo"/></div></Link>
