...
const pricingStyle = {
  ...
  eyn: `max-w-[1000px] mx-auto shadow-xl grid space-y-6 md:space-x-3 md:grid-cols-2 space-y-2 p-10 rounded-md`,
  ...
  btn: `px-3 py-2 bg-[#6948FF] rounded-md text-slate-50 shadow-md hover:shadow-[#6948FF]/50 w-[80%] md:h-[50px] md:w-[250px] hover:opacity-90 transition-all duration-300 ease-in-out`,
    ...
    <div className={pricingStyle.container}>
      ...
      <div className={pricingStyle.eyn}>
        <div className={pricingStyle.txtDiv}>
          ...
          <p className={pricingStyle.text}>
            Includes everything we offer plus unlimited projects and unlimited
            users
          </p>
        </div>
      ...
      <div className={pricingStyle.ayntk}>
        <div className={pricingStyle.ayntkheading}>
          <p className="text-3xl">
            ...
            <span className="text-[#6948FF]">one place</span>
          </p>
          <p className="text-2xl">All in one Platform</p>
          <p className="text-md text-[#808080]">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus
            odit doloribus corrupti enim vel sint laborum voluptatum praesentium
            tenetur voluptate.
          </p>
        </div>
        <div className={pricingStyle.ayntkcontent}>
          <div>
            <ul className={pricingStyle.ayntklist}>
              <li className={pricingStyle.ayntklistitem}>
