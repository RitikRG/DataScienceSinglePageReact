...
const heroStyle = {
  ...
  form: `bg-slate-50 rounded-md shadow-lg flex flex-col p-12 text-[#808080] w-full mx-auto max-w-[400px] md:col-start-2`,
  ...
  btn: `px-3 py-2 bg-[#6948FF] rounded-md text-slate-50 shadow-md hover:shadow-[#6948FF]/50 hover:opacity-90 transition-all duration-300 ease-in-out`,
  tocdiv: `py-4 px-2`,
};
    ...
    <div className={heroStyle.container}>
      <div className={heroStyle.heroContent}>
        ...
        <p className={heroStyle.text}>
          ...
          harum accusantium adipisci? Tempora quaerat accusantium porro esse
          numquam odio error.
        </p>
        <div>
      ...
      <div className={heroStyle.form}>
        ...
        <div className={heroStyle.FTGlogin}>
          <div className={heroStyle.FTGicon}>
            <Link to="/">
              <i>
                <FaFacebook />
              </i>
        ...
        <div>
          <form className="py-4 space-y-8">
            <div className={heroStyle.inputDiv}>
              <input
                ...
                id="name"
                name="name"
                className={heroStyle.input}
                placeholder=" Name"
              />
              <label for="name" className={heroStyle.label} name="name">
                Name
              </label>
            </div>
            <div className={heroStyle.inputDiv}>
              <input
                ...
                placeholder=" Email"
              />
              <label for="email" className={heroStyle.label} name="email">
                Email
              </label>
            </div>
            <div className={heroStyle.inputDiv}>
              ...
              />
              <label for="password" className={heroStyle.label} name="password">
                Password
              </label>
            </div>
          ...
          <div className={heroStyle.tocdiv}>
            <p>
              ...
              <a className="text-[#6948FF] font-semibold">our terms</a>,{" "}
              <a className="text-[#6948FF] font-semibold">Data Privacy</a> and{" "}
              <a className="text-[#6948FF] font-semibold">Cookies policy</a>.
            </p>
          </div>
        </div>
      </div>
