...
const heroStyle = {
    ...
    form: `bg-slate-50 rounded-md shadow-lg flex flex-col p-8 text-[#808080] w-full mx-auto max-w-[400px] md:col-start-2  duration-300`,
    FTGicon: `border-2 w-[30%] flex justify-around items-center py-2 shadow-lg rounded-md hover:scale-110 duration-300`,
    ...
    btn: `px-3 py-2 bg-[#6948FF] rounded-md text-slate-50 hover:shadow-md hover:shadow-[#6948FF]/50 hover:scale-110 duration-300`,
    tocdiv: `py-4 px-2`,
}
            ...
            <div className={heroStyle.form}>
                    ...
                    <div>
                        ...
                        <div className={heroStyle.tocdiv}>
                            <p>By signing up, you agree to <a className='text-[#6948FF] font-semibold cursor-pointer'>our terms</a>, <a className='text-[#6948FF] font-semibold cursor-pointer'>Data Privacy</a> and <a className='text-[#6948FF] font-semibold cursor-pointer'>Cookies policy</a>.</p>
                        </div>
                    </div>
